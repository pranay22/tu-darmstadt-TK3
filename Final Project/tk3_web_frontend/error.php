...
if ($string == '400') {
    ...
    $htmlout = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\"
		...
		<head>
	 <meta http-equiv='refresh' content='5; url=".$TK3GRE['baseurl']."' />
    ...
    <tr>
    <td height='520' valign='top'><img src='{$TK3GRE['pic_base_url']}error404.png' alt='Error Not Found' width='300' height='520' border='0' usemap='#Map' /></td>
    </tr>
    <tr>
    <td height='14' valign='top'><div align='center'><span class='style1'>&copy; TK3 Final Project, Group E</span></div></td>
    </tr>
 ...
 <p align='center'>You will be redirected back to ".$TK3GRE['baseurl']." in 5 seconds</p>
    </body>
    </html>";
    print $htmlout;